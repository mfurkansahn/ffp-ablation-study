...
def main():
    ...
    # define losses
    adversarial_loss, discriminate_loss, gradient_loss, intensity_loss, flow_loss, motion_loss, temporal_loss = def_losses()
    ...
    losses = make_loss_dict(discriminate_loss, intensity_loss, gradient_loss, adversarial_loss, flow_loss, motion_loss, temporal_loss)
